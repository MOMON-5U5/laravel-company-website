            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-4">
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
                        <div class="member">
                            <a href="https://github.com/27rikos" target="_blank">
                                <div class="member-img">
                                    <img src="{{ asset('asset/img/team/team-1.jpg') }}" class="img-fluid" alt="Hasrat B. Lafau" />
                                </div>
                            </a>
                            <div class="social">
                                <hr>
                                <p><b>Lulusan Teknik Informatika Ilmu Komputer Universitas Methodist Indonesia.</b></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
                        <div class="member">
                            <a href="http://andrezai.my.id/" target="_blank">
                                <div class="member-img">
                                    <img src="{{ asset('asset/img/team/team-2.jpg') }}" class="img-fluid" alt="Hasrat B. Lafau" />
                                </div>
                            </a>
                            <div class="social">
                                <hr>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
                        <div class="member">
                            <a href="https://hasratlafau.my.id/" target="_blank">
                                <div class="member-img">
                                    <img src="{{ asset('asset/img/team/team-3.jpg') }}" class="img-fluid" alt="Hasrat B. Lafau" />
                                </div>
                            </a>
                            <div class="social">
                                <hr>
                        ...
                        <div class="row gy-4">
                            <div class="col-md-6">
                                <div class="info-box">
                                    ...
                                    <h3>Alamat</h3>
                                    <p>Jl. Sei Silau No.88 B, Padang Bulan Selayang I,
                                        Kec. Medan Selayang, Kota Medan, Sumatera Utara 20153</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-box">
